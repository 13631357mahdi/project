...
use App\Http\Controllers\back\PrppertiesController;
...
Route::prefix('back.Categories.Category')->group(function(){
...
Route::prefix('back.Properties.Property')->group(function(){
