...
<head>
  ...
  <title>تایم لاین | کنترل پنل</title>
        ...
        <div class="col-md-12">
          ...
          <ul class="timeline">
            ...
            <li>
              ...
              <div class="timeline-item">
                <span class="time"><i class="fa fa-clock-o"></i> 5 روز پیش</span>

                <h3 class="timeline-header"><a href="#">آقای محمدی</a> ویدیو به اشتراک گذاشت</h3>
                ...
                <div class="timeline-footer">
                  <a href="#" class="btn btn-xs bg-maroon">دیدن نظرات</a>
                </div>
              </div>
            </li>
            <!-- END timeline item -->
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-code"></i> کد تایم لاین</h3>
            </div>
            <div class="box-body">
