      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="admin"><i class="fa fa-circle-o"></i>خانه</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> داشبرد اول</a></li>
            <li><a href="{{route('index.category')}}"><i class="fa fa-circle-o"></i>دسته بندی ها</a></li>
            <li><a href="{{route('index.Article')}}"><i class="fa fa-circle-o"></i>مطالب</a></li>
            <li><a href="{{route('index.comment')}}"><i class="fa fa-circle-o"></i>کامنت</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('blank')}}"><i class="fa fa-circle-o"></i> صفحه خالی</a></li>
